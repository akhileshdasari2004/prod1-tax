...
export const homeSeoArticle = {
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'RealFinanceTools is designed for that exploratory phase. We are not a robo-advisor and we do not execute trades. We provide fast, readable tools so you can compare scenarios before you talk to a fiduciary adviser, mortgage loan officer, or certified public accountant (CPA). That separation matters for trust: tools educate; professionals personalize.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'RealFinanceTools publishes transparent tools and educational articles so you can make informed next steps. We cite standard formulas, explain limitations, and avoid pressure tactics. Your financial life deserves clarity; calculators are one disciplined way to get there.',
  ...
  authorNote:
    'Written by the RealFinanceTools editorial team. We update guides when formulas or labels change on our tools. Report inaccuracies via our contact page. Last reviewed June 2026.',
} as const;
